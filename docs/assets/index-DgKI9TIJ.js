(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))e(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&e(i)}).observe(document,{childList:!0,subtree:!0});function n(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function e(t){if(t.ep)return;t.ep=!0;const s=n(t);fetch(t.href,s)}})();class y extends HTMLElement{updateActiveNavigation(){this.querySelectorAll(".main-navigation__link").forEach(s=>{s.classList.remove("main-navigation__link--active")});const n=document.querySelector(".main-content"),e=n?.querySelector("under-construction");if(n?.querySelector("#avatar-sec")&&!e){const s=this.querySelector('.main-navigation__link[data-path="/about"]');s&&s.classList.add("main-navigation__link--active")}else if(e){const s=sessionStorage.getItem("lastClickedPath");if(s){const i=this.querySelector(`.main-navigation__link[data-path="${s}"]`);i&&i.classList.add("main-navigation__link--active")}}}connectedCallback(){this.innerHTML=`<header class="main-header is--container">
...
<nav class="main-navigation">
  <ul class="main-navigation__list is--nolist is--nomargin">
...
</header>`,this.updateActiveNavigation(),this.querySelectorAll(".main-navigation__link").forEach(e=>{e.addEventListener("click",t=>{const s=e.getAttribute("data-path");s&&(sessionStorage.setItem("lastClickedPath",s),setTimeout(()=>{this.updateActiveNavigation()},100))})});const n=document.querySelector(".main-content");n&&new MutationObserver(()=>{this.updateActiveNavigation()}).observe(n,{childList:!0,subtree:!0})}}customElements.define("me-header",y);class r extends HTMLElement{connectedCallback(){this.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 620 620" enable-background="new 0 0 620 620"         xml:space="preserve"><g><polygon points="311,303 288,292 301,316" style="fill:#564031;stroke:#564031;"/>
    ...
    `}}customElements.define("under-construction",f);const a=()=>{const o=document.querySelectorAll("svg g polygon");o.length!==0&&setInterval(()=>{const l=[],n=new Set;for(;l.length<8&&n.size<o.length;){const e=Math.floor(Math.random()*o.length);n.has(e)||(n.add(e),l.push(o[e]))}l.forEach((e,t)=>{setTimeout(()=>{e.classList.add("force-hover"),setTimeout(()=>{e.classList.remove("force-hover")},1e3)},t*200)})},1e3)};a();async function k(){try{return await(await fetch("https://ipapi.co/json/")).json()}catch{return{}}}function c(o){const l=Date.now(),n=1440*60*1e3,e=localStorage.getItem("lastTrackingTime");if(e&&l-parseInt(e)<n)return console.log("Bu tarayıcıdan 24 saat içinde ziyaret kaydedilmiş"),!1;const t=JSON.parse(localStorage.getItem("trackedIPs")||"{}");if(t[o]&&l-t[o]<n)return console.log("Bu IP adresi 24 saat içinde kaydedilmiş"),!1;localStorage.setItem("lastTrackingTime",l.toString()),t[o]=l,localStorage.setItem("trackedIPs",JSON.stringify(t));const s=10080*60*1e3;return Object.keys(t).forEach(i=>{l-t[i]>s&&delete t[i]}),localStorage.setItem("trackedIPs",JSON.stringify(t)),!0}function E(){window.emailjs.init("L1pFLZ9Jno3iyme1o"),d()}async function d(){try{const o=await k();if(!c(o.ip||"unknown"))return;const l={url:window.location.href,referrer:document.referrer||"Direct",userAgent:navigator.userAgent,timestamp:new Date().toISOString(),language:navigator.language,screenResolution:`${screen.width}x${screen.height}`,timezone:Intl.DateTimeFormat().resolvedOptions().timeZone,platform:navigator.platform,cookieEnabled:navigator.cookieEnabled,onlineStatus:navigator.onLine,cpuCores:navigator.hardwareConcurrency||"Unknown",deviceMemory:navigator.deviceMemory||"Unknown",connectionType:navigator.connection?.effectiveType||"Unknown",networkSpeed:navigator.connection?.downlink||"Unknown",country:o.country||"Unknown",city:o.city||"Unknown",region:o.region||"Unknown",latitude:o.latitude||"Unknown",longitude:o.longitude||"Unknown",ip:o.ip||"Unknown",isp:o.org||"Unknown"};window.gtag("event","page_view",{page_title:document.title,page_location:window.location.href,custom_parameter_1:l.referrer}),await window.emailjs.send("service_ne7ebjj","template_domiowi",{to_email:"bnilker@gmail.com",visitor_url:l.url,visitor_referrer:l.referrer,visitor_agent:l.userAgent,visit_time:l.timestamp,visitor_language:l.language,screen_resolution:l.screenResolution,timezone:l.timezone,platform:l.platform,cpu_cores:l.cpuCores,device_memory:l.deviceMemory,connection_type:l.connectionType,network_speed:l.networkSpeed,country:l.country,city:l.city,region:l.region,latitude:l.latitude,longitude:l.longitude,ip_address:l.ip,isp_provider:l.isp})}catch(o){console.error("Tracking hatası:",o)}}window.addEventListener("load",()=>{E()});document.querySelectorAll("polygon").forEach(o=>{o.addEventListener("mouseenter",()=>{o.classList.add("animate"),o.addEventListener("animationend",()=>{o.classList.remove("animate")},{once:!0})}),o.addEventListener("touchstart",()=>{o.classList.add("animate"),o.addEventListener("animationend",()=>{o.classList.remove("animate")},{once:!0})})});function A(){const o=document.querySelector(".main-content");document.querySelectorAll(".main-navigation__link").forEach(t=>{t.addEventListener("click",s=>{s.preventDefault();const i=t.getAttribute("href");i==="/"||i==="/about"?n():e()})});function n(){o&&(o.innerHTML=`
        <div id="avatar-sec">
          <me-avatar></me-avatar>
      ...
      `,setTimeout(()=>{const t=document.getElementById("vertical-typewriter");t&&p(t)},100))}function e(){o&&(o.innerHTML="<under-construction></under-construction>")}}function p(o){const l=o.dataset.typetext||"";let n=-1,e=!0;o.innerHTML="",o.classList.add("show-cursor"),setInterval(()=>{e&&(n<l.length-1?(n++,o.innerHTML+=l.charAt(n)):(e=!1,setTimeout(()=>{const t=setInterval(()=>{o.innerHTML.length>0?o.innerHTML=o.innerHTML.slice(0,-1):(clearInterval(t),n=-1,e=!0)},50)},1500)))},120)}document.addEventListener("DOMContentLoaded",()=>{A(),F(),setTimeout(()=>{const o=document.getElementById("vertical-typewriter");o&&p(o)},250)});function F(){document.querySelectorAll(".main-navigation__link").forEach(l=>{l.addEventListener("touchstart",()=>{l.classList.add("touched")}),l.addEventListener("touchend",()=>{setTimeout(()=>{l.classList.remove("touched")},300)})})}
