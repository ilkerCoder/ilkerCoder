(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const t of l)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(l){const t={};return l.integrity&&(t.integrity=l.integrity),l.referrerPolicy&&(t.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?t.credentials="include":l.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(l){if(l.ep)return;l.ep=!0;const t=i(l);fetch(l.href,t)}})();class y extends HTMLElement{updateActiveNavigation(){this.querySelectorAll(".main-navigation__link").forEach(t=>{t.classList.remove("main-navigation__link--active")});const i=document.querySelector(".main-content"),s=i?.querySelector("under-construction");if(i?.querySelector("#avatar-sec")&&!s){const t=this.querySelector('.main-navigation__link[data-path="/about"]');t&&t.classList.add("main-navigation__link--active")}else if(s){const t=sessionStorage.getItem("lastClickedPath");if(t){const n=this.querySelector(`.main-navigation__link[data-path="${t}"]`);n&&n.classList.add("main-navigation__link--active")}}}connectedCallback(){this.innerHTML=`<header class="main-header is--container">
...
<nav class="main-navigation">
  <ul class="main-navigation__list is--nolist is--nomargin">
    ...
    `}}customElements.define("under-construction",f);const k=()=>{const o=document.querySelectorAll("svg g polygon");o.length!==0&&setInterval(()=>{const e=[],i=new Set;for(;e.length<8&&i.size<o.length;){const s=Math.floor(Math.random()*o.length);i.has(s)||(i.add(s),e.push(o[s]))}e.forEach((s,l)=>{setTimeout(()=>{s.classList.add("force-hover"),setTimeout(()=>{s.classList.remove("force-hover")},1e3)},l*200)})},1e3)};k();function a(){window.emailjs.init("L1pFLZ9Jno3iyme1o"),c()}async function c(){try{const o={url:window.location.href,referrer:document.referrer||"Direct",userAgent:navigator.userAgent,timestamp:new Date().toISOString(),language:navigator.language,screenResolution:`${screen.width}x${screen.height}`,timezone:Intl.DateTimeFormat().resolvedOptions().timeZone};window.gtag("event","page_view",{page_title:document.title,page_location:window.location.href,custom_parameter_1:o.referrer}),await window.emailjs.send("service_ne7ebjj","template_domiowi",{to_email:"bnilker@gmail.com",visitor_url:o.url,visitor_referrer:o.referrer,visitor_agent:o.userAgent,visit_time:o.timestamp,visitor_language:o.language,screen_resolution:o.screenResolution,timezone:o.timezone})}catch(o){console.error("Tracking hatası:",o)}}window.addEventListener("load",()=>{a()});document.querySelectorAll("polygon").forEach(o=>{o.addEventListener("mouseenter",()=>{o.classList.add("animate"),o.addEventListener("animationend",()=>{o.classList.remove("animate")},{once:!0})}),o.addEventListener("touchstart",()=>{o.classList.add("animate"),o.addEventListener("animationend",()=>{o.classList.remove("animate")},{once:!0})})});function E(){const o=document.querySelector(".main-content");document.querySelectorAll(".main-navigation__link").forEach(l=>{l.addEventListener("click",t=>{t.preventDefault();const n=l.getAttribute("href");n==="/"||n==="/about"?i():s()})});function i(){o&&(o.innerHTML=`
        <div id="avatar-sec">
          <me-avatar></me-avatar>
      ...
      `,setTimeout(()=>{const l=document.getElementById("vertical-typewriter");l&&p(l)},100))}function s(){o&&(o.innerHTML="<under-construction></under-construction>")}}function p(o){const e=o.dataset.typetext||"";let i=-1,s=!0;o.innerHTML="",o.classList.add("show-cursor"),setInterval(()=>{s&&(i<e.length-1?(i++,o.innerHTML+=e.charAt(i)):(s=!1,setTimeout(()=>{const l=setInterval(()=>{o.innerHTML.length>0?o.innerHTML=o.innerHTML.slice(0,-1):(clearInterval(l),i=-1,s=!0)},50)},1500)))},120)}document.addEventListener("DOMContentLoaded",()=>{E(),A(),setTimeout(()=>{const o=document.getElementById("vertical-typewriter");o&&p(o)},250)});function A(){document.querySelectorAll(".main-navigation__link").forEach(e=>{e.addEventListener("touchstart",()=>{e.classList.add("touched")}),e.addEventListener("touchend",()=>{setTimeout(()=>{e.classList.remove("touched")},300)})})}
